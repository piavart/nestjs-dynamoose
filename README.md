...
[Dynamoose](https://dynamoosejs.com/) v3 module for [Nest](https://github.com/nestjs/nest).
...
## Base Project
The [Base](https://github.com/hardyscc/nestjs-dynamoose) project is taken as a basis, and adapted for version 3 of dynamoose.
...
`User` holds all attributes of the document/item. When creating this two interfaces and using when injecting your model you will have typechecking when using operations like `Model.update()`.
